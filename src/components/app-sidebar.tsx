...
export function AppSidebar() {
  ...
  useEffect(() => {
    const isCorteDeCaja = pathname.startsWith('/corte-de-caja');
    const isConfig = pathname.startsWith('/configuracion');
    if (isCorteDeCaja || isConfig) {
      setCorteDeCajaOpen(true);
    }
    if (isConfig) {
      setConfiguracionOpen(true);
    }
  }, [pathname, setCorteDeCajaOpen, setConfiguracionOpen]);
      ...
      <SidebarContent>
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              tooltip="Producto Estrella"
              isActive={pathname === '/producto-estrella'}
            >
          ...
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              tooltip="Análisis por SKU"
              isActive={pathname === '/analisis-sku'}
            >
          ...
          <SidebarMenuItem>
            <Collapsible
              open={corteDeCajaOpen}
              onOpenChange={setCorteDeCajaOpen}
              className="w-full"
            >
              ...
              <CollapsibleContent>
                <SidebarMenuSub>
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton
                      asChild
                      isActive={pathname === '/corte-de-caja'}
                    >
                  ...
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton
                      asChild
                      isActive={pathname === '/corte-de-caja/nuevo-corte'}
                    >
                  ...
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton
                      asChild
                      isActive={pathname === '/corte-de-caja/historial'}
                    >
                  ...
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton
                      asChild
                      isActive={pathname === '/corte-de-caja/publicaciones'}
                    >
                      <Link href="/corte-de-caja/publicaciones">
                        Publicaciones
                      </Link>
                    </SidebarMenuSubButton>
                  </SidebarMenuSubItem>
                        ...
                        <SidebarMenuSub>
                          <SidebarMenuSubItem>
                            <SidebarMenuSubButton
                              asChild
                              isActive={
                                pathname === '/configuracion/categorias'
                              }
                            >
